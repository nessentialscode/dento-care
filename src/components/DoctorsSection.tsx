  ...
  return (
    <section id="doctors" className="relative w-full px-3 sm:px-6 md:px-8 lg:px-10 py-12 sm:py-20">
      <div className="max-w-[1520px] mx-auto">
        ...
        {/* 2-CARD HORIZONTAL CAROUSEL CONTAINER (SINGLE POSITION, ONE VISIBLE AT A TIME) */}
        <div className="relative max-w-[480px] sm:max-w-[500px] mx-auto px-2">
          
          {/* DESKTOP / TABLET CHEVRON NAVIGATION (LEFT) */}
          <button
            type="button"
          ...
          {/* DESKTOP / TABLET CHEVRON NAVIGATION (RIGHT) */}
          <button
            type="button"
